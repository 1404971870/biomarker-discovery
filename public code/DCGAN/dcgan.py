...
parser.add_argument("--save_dir", type=str, default="checkpoints_test", help="folder to save checkpoints")
parser.add_argument('--train_data_path', type=str, default="/data/sunys/program/PyTorch-GAN-master/data/8474_concat_iri_msi_images", help='Path to the training data directory.')
parser.add_argument('--checkpoint_path', type=str, default='checkpoint.pth.tar', help='Path to the checkpoint file.')
parser.add_argument('--save_image_path', type=str, default="images_test", help='Path to the training data directory.')
