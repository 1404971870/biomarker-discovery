...
parser.add_argument("--dataset_name", type=str, default="1000epch_single_train_WSIimage_iri", help="name of the dataset")
...
def main():
    ...
    #
    #
    low_wsi = load_low_wsi('/data/sunys/program/PyTorch-GAN-master/data/iri_wsi.png')
    ...
    dataloader = DataLoader(
        high_customDataset(root_msi='/data/sunys/program/PyTorch-GAN-master/data/iri_valid_images_3',
                      transforms_msi=transforms_msi, transforms_wsi=transforms_wsi, mode="train", angle=-90),
    ...
    for i, batch in enumerate(dataloader):
        ...
        # 打印当前进度和剩余时间
        print(
            f"\n Batch {batches_done}/{total_batches}, Elapsed Time: {elapsed_time:.2f}s, Remaining Time: {hours}h {minutes}m {seconds}s")
